...
private void initialize() {
	...
	frame.setVisible(true);
		...
		btnNewButton2.setBackground(Color.WHITE);
				...
				//-----------------------------------------------------------//
					//     Поле с таймером
					JLabel txtregр4 = new JLabel("Time:");
txtregр4.setFont(new Font("Tahoma",Font.PLAIN,20));
					txtregр4.setForeground(Color.RED);
					txtregр4.setBounds(60, 13, 120, 23);
					frame.getContentPane().add(txtregр4);
					//     Поле с таймером
					JLabel txtregр3 = new JLabel("00:00");
					txtregр3.setHorizontalAlignment(SwingConstants.CENTER);
					txtregр3.setFont(new Font("Tahoma",Font.PLAIN,20));
					txtregр3.setForeground(Color.RED);
					txtregр3.setBounds(90, 15, 120, 23);
					frame.getContentPane().add(txtregр3);
